...
public class termios {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Mac.C_LONG.withName("c_iflag"),
        Mac.C_LONG.withName("c_oflag"),
        Mac.C_LONG.withName("c_cflag"),
        Mac.C_LONG.withName("c_lflag"),
        MemoryLayout.sequenceLayout(20, Mac.C_CHAR).withName("c_cc"),
        MemoryLayout.paddingLayout(4),
        Mac.C_LONG.withName("c_ispeed"),
        Mac.C_LONG.withName("c_ospeed")
    ).withName("termios");
